...
Requeuing resets the attempt counter and creation time so the row gets a fresh attempt and age budget; without both resets it would be failed again at the next scheduling.
